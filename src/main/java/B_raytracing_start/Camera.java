...
public class Camera {
     ...
     * Rückgabewert: Ein Ray, der vom Ursprung der Kamera (0, 0, 0) zum Pixel (x, y) zeigt.
     */
     ...
     * Rückgabewert: Der Wert der Blende (alpha)
     */
     ...
     * Rückgabewert: Die Breite der Bildebene in Pixeln
     */
    public int getWidth() {
        return width;
    }
     ...
     * Rückgabewert: Die Höhe der Bildebene in Pixeln
     */
